...
<body>
<div id="wrap">
    <h4>Basketball Attendance</h4>
    <div class="jumbotron" style="padding: 0px 20px 20px 20px">

        <h3 align="center">(Men)</h3>
        <div align="right">
            <a href="basketball_attendance_women.html"><input type="button" class="btn btn-primary" value="Click for view Women attendance"></a>
            &nbsp;&nbsp;
        </div>
        <form action="#">
